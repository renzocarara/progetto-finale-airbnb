...
<div class="container">
    ...
    <div class="row">
        <div class="card apt-show-row col-sm-12 col-lg-6">
            <img class="card-body card-img-top apt-img-lg" src="{{$apartment->info->image ? asset('storage/uploads/no_apt_img.png' . $apartment->info->image) : asset('storage/uploads/no_apt_img.png')}}" alt="{{$apartment->title}}">
            <div class="card-body">
