{{-- <button id="create-btn" type="button" class="btn btn-green" data-toggle="modal" data-target="#create-modal"> --}}
<button id="create-btn" type="button" class="btn btn-green">
    Crea
</button>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="create-modal-title">Creazione di un nuovo appartamento</h5>
...
<div class="modal fade" id="err-create-modal" tabindex="-1" role="dialog" aria-labelledby="err-create-modal-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
