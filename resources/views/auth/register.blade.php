...
<div class="container">
    <div class="row justify-content-center">
        <div class="margin-top-xl margin-bottom-xl col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-md-6">
                               <input id="date_of_birth" type="date" class="form-control @error('date_of_birth') is-invalid @enderror" name="date_of_birth" value="{{ old('date_of_birth') }}" autocomplete="date_of_birth" autofocus placeholder='dd/mm/yyyy'>
